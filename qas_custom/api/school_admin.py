...
from qas_custom.services.material_orders import (
	...
	delete_school_admin_store_product_category_data,
	...
	delete_school_admin_store_product_data,
...
@frappe.whitelist()
def school_admin_get_store_products(active=None, query=None, limit=160):
	return get_school_admin_store_products_data(active=active, query=query, limit=limit)
...
def school_admin_delete_store_product_category(category=None, modified=None):
	return delete_school_admin_store_product_category_data(category=category, modified=modified)
...
@frappe.whitelist()
def school_admin_get_store_order(order=None):
	return get_school_admin_store_order_data(order=order)


@frappe.whitelist()
def school_admin_get_store_order_options(parent=None):
	return get_school_admin_store_order_options_data(parent=parent)


@frappe.whitelist()
def school_admin_create_store_order(payload=None):
	return create_school_admin_store_order_data(payload=payload)


@frappe.whitelist()
def school_admin_update_store_order_status(order=None, status=None, reason=None):
	return update_school_admin_store_order_status_data(order=order, status=status, reason=reason)
...
@frappe.whitelist()
def school_admin_get_inquiries(status=None, inquiry_type=None, confirmation_status=None, campus=None, from_date=None, to_date=None, queue=None, query=None, limit_start=0, limit=80):
...
@frappe.whitelist()
def school_admin_continue_enrollment_to_term(enrollment=None, payload=None):
	return continue_school_admin_enrollment_to_term_data(enrollment=enrollment, payload=payload)
...
@frappe.whitelist()
def school_admin_consolidate_invoices(payload=None):
